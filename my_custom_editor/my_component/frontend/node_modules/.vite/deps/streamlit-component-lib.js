...
//#endregion
//#region node_modules/streamlit-component-lib/node_modules/react/cjs/react.development.js
...
current: null };
		...
		function printWarning(level, format, args) {
			if (!(args.length > 0 && typeof args[args.length - 1] === "string" && args[args.length - 1].indexOf("\n    in") === 0)) {
...
//#endregion
//#region node_modules/streamlit-component-lib/node_modules/react/index.js
...
function fromAsyncIterable(source) {
	return __asyncGenerator(this, arguments, function* fromAsyncIterable_1() {
		...
		try {
			...
			threw === false && typeof it.return === "function" && (yield __await(it.return(/* @__PURE__ */ new Uint8Array(0))));
		}
...
function fromNodeStream(stream) {
	return __asyncGenerator(this, arguments, function* fromNodeStream_1() {
		...
		({cmd, size} = yield yield __await(null));
		if (stream["isTTY"]) {
			yield yield __await(/* @__PURE__ */ new Uint8Array(0));
			return yield __await(null);
		}
		try {
...
function valueToString(x) {
	...
	if (ArrayBuffer.isView(x)) {
		if (x instanceof BigInt64ArrayCtor || x instanceof BigUint64ArrayCtor) return `[${[...x].map((x) => valueToString(x))}]`;
		return `[${x}]`;
	}
...
function decimalToString(a) {
	let digits = "";
	const base64 = /* @__PURE__ */ new Uint32Array(2);
...
var BN = class BN {
	...
	static new(num, isSigned) {
		...
		switch (num.constructor) {
			...
			case Int16Array:
			case Int32Array:
			case BigInt64ArrayCtor: return new SignedBigNum(num);
		}
...
/** @ignore */
var Null$1 = class extends DataType {
	toString() {
		return `Null`;
	}
	get typeId() {
...
var Float = class extends DataType {
	...
	get ArrayType() {
		switch (this.precision) {
			case Precision$1.HALF: return Uint16Array;
			case Precision$1.SINGLE: return Float32Array;
			case Precision$1.DOUBLE: return Float64Array;
		}
		throw new Error(`Unrecognized ${this[Symbol.toStringTag]} type`);
	}
	toString() {
...
/** @ignore */
var Binary$1 = class extends DataType {
	constructor() {
		super();
	}
	get typeId() {
...
/** @ignore */
var Utf8$1 = class extends DataType {
	constructor() {
		super();
	}
	get typeId() {
...
/** @ignore */
var Bool$1 = class extends DataType {
	constructor() {
		super();
	}
	get typeId() {
...
/** @ignore */
var Decimal$1 = class extends DataType {
...
/** @ignore */
var List$1 = class extends DataType {
	constructor(child) {
		super();
		this.children = [child];
	}
...
/** @ignore */
var FixedSizeBinary$1 = class extends DataType {
...
/** @ignore */
var FixedSizeList$1 = class extends DataType {
...
function strideForType(type) {
	const t = type;
	switch (type.typeId) {
		case Type$1.Decimal: return type.bitWidth / 32;
...
function getVisitFn(visitor, node, throwIfNotFound = true) {
	...
	if (typeof node === "string" && node in Type$1) return getVisitFnByTypeId(visitor, Type$1[node], throwIfNotFound);
...
function getVisitFnByTypeId(visitor, dtype, throwIfNotFound = true) {
	...
	switch (dtype) {
		...
		case Type$1.FixedSizeList:
			...
			break;
		case Type$1.Map: fn = visitor.visitMap;
	}
	...
	switch (type.typeId) {
		...
		case Type$1.Float:
			switch (type.precision) {
				case Precision$1.HALF: return Type$1.Float16;
				case Precision$1.SINGLE: return Type$1.Float32;
				case Precision$1.DOUBLE: return Type$1.Float64;
			}
			return Type$1.Float;
		...
		case Type$1.Time:
			switch (type.unit) {
				case TimeUnit$1.SECOND: return Type$1.TimeSecond;
				case TimeUnit$1.MILLISECOND: return Type$1.TimeMillisecond;
				case TimeUnit$1.MICROSECOND: return Type$1.TimeMicrosecond;
				case TimeUnit$1.NANOSECOND: return Type$1.TimeNanosecond;
			}
			return Type$1.Time;
		case Type$1.Timestamp:
			switch (type.unit) {
				case TimeUnit$1.SECOND: return Type$1.TimestampSecond;
				case TimeUnit$1.MILLISECOND: return Type$1.TimestampMillisecond;
				case TimeUnit$1.MICROSECOND: return Type$1.TimestampMicrosecond;
				case TimeUnit$1.NANOSECOND: return Type$1.TimestampNanosecond;
			}
			return Type$1.Timestamp;
		case Type$1.Date:
			switch (type.unit) {
				case DateUnit$1.DAY: return Type$1.DateDay;
				case DateUnit$1.MILLISECOND: return Type$1.DateMillisecond;
			}
			return Type$1.Date;
		case Type$1.Interval:
			switch (type.unit) {
				case IntervalUnit$1.DAY_TIME: return Type$1.IntervalDayTime;
				case IntervalUnit$1.YEAR_MONTH: return Type$1.IntervalYearMonth;
			}
			return Type$1.Interval;
		...
		case Type$1.Union:
			switch (type.mode) {
				case UnionMode$1.Dense: return Type$1.DenseUnion;
				case UnionMode$1.Sparse: return Type$1.SparseUnion;
			}
			return Type$1.Union;
...
function uint16ToFloat64(h) {
	...
	switch (expo) {
		case 31: return sign * (sigf ? NaN : 1 / 0);
...
var setAnyFloat = (data, index, value) => {
	switch (data.type.precision) {
		case Precision$1.HALF: return setFloat16(data, index, value);
		case Precision$1.SINGLE:
		case Precision$1.DOUBLE: return setFloat(data, index, value);
	}
};
/** @ignore */
...
var setTimestamp = (data, index, value) => {
	switch (data.type.unit) {
		case TimeUnit$1.SECOND: return setTimestampSecond(data, index, value);
		case TimeUnit$1.MILLISECOND: return setTimestampMillisecond(data, index, value);
		case TimeUnit$1.MICROSECOND: return setTimestampMicrosecond(data, index, value);
		case TimeUnit$1.NANOSECOND: return setTimestampNanosecond(data, index, value);
	}
};
/** @ignore */
...
var setTime = (data, index, value) => {
	switch (data.type.unit) {
		case TimeUnit$1.SECOND: return setTimeSecond(data, index, value);
		case TimeUnit$1.MILLISECOND: return setTimeMillisecond(data, index, value);
		case TimeUnit$1.MICROSECOND: return setTimeMicrosecond(data, index, value);
		case TimeUnit$1.NANOSECOND: return setTimeNanosecond(data, index, value);
	}
};
/** @ignore */
...
var setList = (data, index, value) => {
	...
	const set = instance$7.getVisitFn(values);
...
var setFixedSizeList = (data, index, value) => {
	...
	const set = instance$7.getVisitFn(child);
...
var StructRow = class {
	...
	toJSON() {
		...
		const json = {};
		for (let j = -1, n = keys.length; ++j < n;) json[keys[j].name] = instance$6.visit(parent.children[j], i);
		return json;
	}
	toString() {
	...
	next() {
		...
		if (i < this.numChildren) {
			...
			return {
				...
				value: [this.childFields[i].name, instance$6.visit(this.children[i], this.rowIndex)]
			};
		}
		return {
			done: true,
...
/** @ignore */ var epochMillisecondsLongToMs = (data, index) => 4294967296 * data[index + 1] + (data[index] >>> 0);
/** @ignore */ var epochMicrosecondsLongToMs = (data, index) => 4294967296 * (data[index + 1] / 1e3) + (data[index] >>> 0) / 1e3;
/** @ignore */ var epochNanosecondsLongToMs = (data, index) => 4294967296 * (data[index + 1] / 1e6) + (data[index] >>> 0) / 1e6;
/** @ignore */ var epochMillisecondsToDate = (epochMs) => new Date(epochMs);
/** @ignore */ var epochDaysToDate = (data, index) => epochMillisecondsToDate(epochDaysToMs(data, index));
/** @ignore */ var epochMillisecondsLongToDate = (data, index) => epochMillisecondsToDate(epochMillisecondsLongToMs(data, index));
/** @ignore */
...
/* istanbul ignore next */
/** @ignore */
var getFloat = ({ type, values }, index) => type.precision !== Precision$1.HALF ? values[index] : uint16ToFloat64(values[index]);
/* istanbul ignore next */
/** @ignore */
var getDate = (data, index) => data.type.unit === DateUnit$1.DAY ? getDateDay(data, index) : getDateMillisecond(data, index);
/** @ignore */
...
var getTimestamp = (data, index) => {
	switch (data.type.unit) {
		case TimeUnit$1.SECOND: return getTimestampSecond(data, index);
		case TimeUnit$1.MILLISECOND: return getTimestampMillisecond(data, index);
		case TimeUnit$1.MICROSECOND: return getTimestampMicrosecond(data, index);
		case TimeUnit$1.NANOSECOND: return getTimestampNanosecond(data, index);
	}
};
/** @ignore */
...
var getTime = (data, index) => {
	switch (data.type.unit) {
		case TimeUnit$1.SECOND: return getTimeSecond(data, index);
		case TimeUnit$1.MILLISECOND: return getTimeMillisecond(data, index);
		case TimeUnit$1.MICROSECOND: return getTimeMicrosecond(data, index);
		case TimeUnit$1.NANOSECOND: return getTimeNanosecond(data, index);
	}
};
/** @ignore */
...
/* istanbul ignore next */
/** @ignore */
var getInterval = (data, index) => data.type.unit === IntervalUnit$1.DAY_TIME ? getIntervalDayTime(data, index) : getIntervalYearMonth(data, index);
/** @ignore */
var getIntervalDayTime = ({ values }, index) => values.subarray(2 * index, 2 * (index + 1));
/** @ignore */
var getIntervalYearMonth = ({ values }, index) => {
	const interval = values[index];
	const int32s = /* @__PURE__ */ new Int32Array(2);
...
var MapRow = class {
	...
	toJSON() {
		...
		const json = {};
		for (let i = -1, n = keys.length; ++i < n;) json[keys.get(i)] = instance$6.visit(vals, i);
		return json;
	}
	toString() {
		return `{${[...this].map(([key, val]) => `${valueToString(key)}: ${valueToString(val)}`).join(", ")}}`;
...
var MapRowIterator = class {
	...
	next() {
		...
		return {
			...
			value: [this.keys.get(i), instance$6.visit(this.vals, i)]
		};
	}
};
/** @ignore */
var MapRowProxyHandler = class {
	...
	getOwnPropertyDescriptor(row, key) {
		if (row[kKeys].indexOf(key) !== -1) return {
			writable: true,
			enumerable: true,
			configurable: true
		};
...
var Data = class Data {
	...
	get nullCount() {
		...
		let nullBitmap;
		if (nullCount <= -1 && (nullBitmap = this.nullBitmap)) this._nullCount = nullCount = this.length - popcnt_bit_range(nullBitmap, this.offset, this.offset + this.length);
		return nullCount;
	}
	getValid(index) {
	...
	_changeLengthAndBackfillNullBitmap(newLength) {
		if (this.typeId === Type$1.Null) return this.clone(this.type, 0, newLength, 0);
...
/** @ignore */
var instance$5 = new IndexOfVisitor();
//#endregion
...
function vectorIterator(vector) {
	const { type } = vector;
	if (vector.nullCount === 0 && vector.stride === 1 && (type.typeId === Type$1.Timestamp || type instanceof Int_ && type.bitWidth !== 64 || type instanceof Time_ && type.bitWidth !== 64 || type instanceof Float && type.precision !== Precision$1.HALF)) return new ChunkedIterator(vector.data.length, (chunkIndex) => {
...
/** @ignore */
var instance$4 = new IteratorVisitor();
//#endregion
//#region node_modules/apache-arrow/visitor/bytelength.mjs
/* istanbul ignore file */
/** @ignore */ var sum = (x, y) => x + y;
/** @ignore */
...
var getDenseUnionByteLength = ({ type, children, typeIds, valueOffsets }, index) => {
	...
	return 8 + instance$3.visit(children[childIndex], valueOffsets[index]);
};
/** @ignore */
var getSparseUnionByteLength = ({ children }, index) => {
	return 4 + instance$3.visitMany(children, children.map(() => index)).reduce(sum, 0);
};
...
/** @ignore */
var instance$3 = new GetByteLengthVisitor();
//#endregion
	...
	*/
	toArray() {
		...
		switch (type.typeId) {
			...
			case Type$1.Decimal:
			case Type$1.Time:
			case Type$1.Timestamp: switch (data.length) {
...
Vector[_a$2] = ((proto) => {
	...
	for (const typeId of typeIds) {
		visitorsByTypeId[typeId] = {
			get: instance$6.getVisitFnByTypeId(typeId),
			set: instance$7.getVisitFnByTypeId(typeId),
			indexOf: instance$5.getVisitFnByTypeId(typeId),
			byteLength: instance$3.getVisitFnByTypeId(typeId)
		};
...
function valueToCase(x) {
	...
	else if (BigIntAvailable) return `${valueToString(x)}n`;
	return `"${valueToString(x)}"`;
}
//#endregion
//#region node_modules/apache-arrow/builder/buffer.mjs
/** @ignore */
var roundLengthUpToNearest64Bytes = (len, BPE) => (Math.ceil(len) * BPE + 63 & -64 || 64) / BPE;
/** @ignore */
...
var BitmapBufferBuilder = class extends DataBufferBuilder {
	constructor(data = /* @__PURE__ */ new Uint8Array(0)) {
		super(data, 1 / 8);
		this.numValid = 0;
	}
	get numInvalid() {
...
var OffsetsBufferBuilder = class extends DataBufferBuilder {
	constructor(data = /* @__PURE__ */ new Int32Array(1)) {
		super(data, 1);
	}
	append(value) {
...
/** @ignore */
var FixedWidthBuilder = class extends Builder$3 {
	constructor(opts) {
		super(opts);
...
/** @ignore */
var VariableWidthBuilder = class extends Builder$3 {
	constructor(opts) {
		super(opts);
...
var int32 = /* @__PURE__ */ new Int32Array(2);
var float32 = new Float32Array(int32.buffer);
var float64 = new Float64Array(int32.buffer);
var isLittleEndian = new Uint16Array(new Uint8Array([1, 0]).buffer)[0] === 1;
//#endregion
//#region node_modules/flatbuffers/mjs/long.js
var Long$3 = class Long$3 {
...
var ByteBuffer$2 = class ByteBuffer$2 {
	...
	*/
	__string(offset, opt_encoding) {
		...
		let i = 0;
		offset += 4;
		if (opt_encoding === Encoding.UTF8_BYTES) return this.bytes_.subarray(offset, offset + length);
		while (i < length) {
			let codePoint;
...
var Builder$2 = class Builder$2 {
	...
	*/
	finish(root_table, opt_file_identifier, opt_size_prefix) {
		...
		if (opt_file_identifier) {
			...
			if (file_identifier.length != 4) throw new Error("FlatBuffers: file identifier must be length 4");
	...
	*/
	requiredField(table, field) {
		...
		if (!(this.bb.readInt16(vtable_start + field) != 0)) throw new Error("FlatBuffers: field " + field + " must be set");
	}
	/**
	...
	createString(s) {
		...
		if (s instanceof Uint8Array) utf8 = s;
			...
			while (i < s.length) {
				...
				if (a < 55296 || a >= 56320) codePoint = a;
				else {
					const b = s.charCodeAt(i++);
					codePoint = (a << 10) + b + -56613888;
				}
				if (codePoint < 128) utf8.push(codePoint);
				else {
					if (codePoint < 2048) utf8.push(codePoint >> 6 & 31 | 192);
					else {
						if (codePoint < 65536) utf8.push(codePoint >> 12 & 15 | 224);
						else utf8.push(codePoint >> 18 & 7 | 240, codePoint >> 12 & 63 | 128);
...
var FixedSizeBinary = class FixedSizeBinary {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
var FixedSizeList = class FixedSizeList {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/fb/struct_.mjs
/**
...
var Schema = class Schema {
	constructor(fields = [], metadata, dictionaries) {
		...
		if (!dictionaries) dictionaries = generateDictionaryMap(fields);
...
var Footer_ = class {
	...
	static decode(buf) {
		...
		return new OffHeapFooter(Schema.decode(footer.schema()), footer);
	}
	/** @nocollapse */
...
var Uint64 = class Uint64 extends BaseInt64 {
	...
	/** @nocollapse */
	static from(val, out_buffer = /* @__PURE__ */ new Uint32Array(2)) {
		return Uint64.fromString(typeof val === "string" ? val : val.toString(), out_buffer);
	}
	/** @nocollapse */
	static fromNumber(num, out_buffer = /* @__PURE__ */ new Uint32Array(2)) {
		return Uint64.fromString(num.toString(), out_buffer);
	}
	/** @nocollapse */
	static fromString(str, out_buffer = /* @__PURE__ */ new Uint32Array(2)) {
...
var Int128 = class Int128 {
	...
	plus(other) {
		const sums = /* @__PURE__ */ new Uint32Array(4);
	...
	/** @nocollapse */
	static from(val, out_buffer = /* @__PURE__ */ new Uint32Array(4)) {
		return Int128.fromString(typeof val === "string" ? val : val.toString(), out_buffer);
	}
	/** @nocollapse */
	static fromNumber(num, out_buffer = /* @__PURE__ */ new Uint32Array(4)) {
		return Int128.fromString(num.toString(), out_buffer);
	}
	/** @nocollapse */
	static fromString(str, out_buffer = /* @__PURE__ */ new Uint32Array(4)) {
		const negate = str.startsWith("-");
		const length = str.length;
...
var VectorLoader = class extends Visitor {
	...
	readNullBitmap(type, nullCount, buffer = this.nextBufferRange()) {
		return nullCount > 0 && this.readData(type, buffer) || /* @__PURE__ */ new Uint8Array(0);
	}
...
var JSONVectorLoader = class extends VectorLoader {
	constructor(sources, nodes, buffers, dictionaries) {
		super(/* @__PURE__ */ new Uint8Array(0), nodes, buffers, dictionaries);
		this.sources = sources;
	}
	readNullBitmap(_type, nullCount, { offset } = this.nextBufferRange()) {
		return nullCount <= 0 ? /* @__PURE__ */ new Uint8Array(0) : packBools(this.sources[offset]);
	}
	...
	readData(type, { offset } = this.nextBufferRange()) {
		...
		else if (DataType.isDate(type) && type.unit === DateUnit$1.MILLISECOND) return toArrayBufferView(Uint8Array, Int64.convertArray(sources[offset]));
		...
		else if (DataType.isUtf8(type)) return encodeUtf8(sources[offset].join(""));
...
var BinaryBuilder = class extends VariableWidthBuilder {
	constructor(opts) {
		super(opts);
		this._values = new BufferBuilder(/* @__PURE__ */ new Uint8Array(0));
	}
	get byteLength() {
...
/** @ignore */
var BoolBuilder = class extends Builder$3 {
	constructor(options) {
		super(options);
...
/** @ignore */
var DictionaryBuilder = class extends Builder$3 {
...
/** @ignore */
var FixedSizeListBuilder = class extends Builder$3 {
	setValue(index, value) {
...
/** @ignore */
var NullBuilder = class extends Builder$3 {
	setValue(index, value) {}
	setValid(index, valid) {
...
/** @ignore */
var StructBuilder = class extends Builder$3 {
	setValue(index, value) {
...
/** @ignore */
var UnionBuilder = class extends Builder$3 {
	constructor(options) {
		super(options);
		this._typeIds = new DataBufferBuilder(/* @__PURE__ */ new Int8Array(0), 1);
...
var DenseUnionBuilder = class extends UnionBuilder {
	constructor(options) {
		super(options);
		this._offsets = new DataBufferBuilder(/* @__PURE__ */ new Int32Array(0));
	}
	/** @ignore */
	setValue(index, value, childTypeId) {
...
function uniformlyDistributeChunksAcrossRecordBatches(schema, cols) {
	...
	return [schema = schema.assign(fields), batches.map((data) => new RecordBatch$2(schema, data))];
}
/** @ignore */
...
var Table = class Table {
	constructor(...args) {
		...
		const unwrap = (x) => {
			if (x) {
				if (x instanceof RecordBatch$2) return [x];
				else if (x instanceof Table) return x.batches;
				else if (x instanceof Data) {
					if (x.type instanceof Struct) return [new RecordBatch$2(new Schema(x.type.children), x)];
					...
					const [, batches] = distributeVectorsIntoRecordBatches(new Schema(keys.map((k, i) => new Field(String(k), vecs[i].type))), vecs);
					return batches.length === 0 ? [new RecordBatch$2(x)] : batches;
				}
			}
			return [];
		};
		...
		for (const batch of batches) {
			if (!(batch instanceof RecordBatch$2)) throw new TypeError("Table constructor expects a [Schema, RecordBatch[]] pair.");
	...
	*/
	[Symbol.iterator]() {
		if (this.batches.length > 0) return instance$4.visit(new Vector(this.data));
	...
	*/
	concat(...others) {
		...
		return new Table(schema, data.map((data) => new RecordBatch$2(schema, data)));
	}
	/**
...
var RecordBatch$2 = class RecordBatch$2 {
	...
	*/
	select(columnNames) {
		...
		return new RecordBatch$2(schema, makeData({
			type,
			length: this.numRows,
			children
		}));
...
function collectDictionaries(fields, children, dictionaries = /* @__PURE__ */ new Map()) {
	for (let i = -1, n = fields.length; ++i < n;) {
		...
		if (type.children && type.children.length > 0) collectDictionaries(type.children, data.children, dictionaries);
	}
	return dictionaries;
}
/**
...
* @private
*/
var _InternalEmptyPlaceholderRecordBatch = class extends RecordBatch$2 {
	constructor(schema) {
...
var Message = class Message {
	constructor(bodyLength, version, headerType, header) {
		...
		this.body = /* @__PURE__ */ new Uint8Array(0);
	...
	static from(header, bodyLength = 0) {
		if (header instanceof Schema) return new Message(0, MetadataVersion$1.V4, MessageHeader$1.Schema, header);
		if (header instanceof RecordBatch) return new Message(bodyLength, MetadataVersion$1.V4, MessageHeader$1.RecordBatch, header);
		if (header instanceof DictionaryBatch) return new Message(bodyLength, MetadataVersion$1.V4, MessageHeader$1.DictionaryBatch, header);
...
function messageHeaderFromJSON(message, type) {
	return (() => {
		switch (type) {
			case MessageHeader$1.Schema: return Schema.fromJSON(message);
			case MessageHeader$1.RecordBatch: return RecordBatch.fromJSON(message);
			case MessageHeader$1.DictionaryBatch: return DictionaryBatch.fromJSON(message);
		}
...
function decodeSchema(_schema, dictionaries = /* @__PURE__ */ new Map()) {
	return new Schema(decodeSchemaFields(_schema, dictionaries), decodeCustomMetadata(_schema), dictionaries);
}
/** @ignore */
...
function decodeBuffers(batch, version) {
	...
	for (let b, i = -1, j = -1, n = batch.buffersLength(); ++i < n;) if (b = batch.buffers(i)) {
		if (version < MetadataVersion$1.V4) b.bb_pos += 8 * (i + 1);
...
function decodeFieldType(f, children) {
	...
	switch (typeId) {
		...
		case Type["FloatingPoint"]: return new Float(f.type(new FloatingPoint()).precision());
		case Type["Decimal"]: {
			const t = f.type(new Decimal());
			return new Decimal$1(t.scale(), t.precision(), t.bitWidth());
		}
		case Type["Date"]: return new Date_(f.type(new Date$1()).unit());
		case Type["Time"]: {
		...
		case Type["Interval"]: return new Interval_(f.type(new Interval()).unit());
		case Type["Union"]: {
			const t = f.type(new Union());
			return new Union_(t.mode(), t.typeIdsArray() || [], children || []);
		}
		case Type["FixedSizeBinary"]: return new FixedSizeBinary$1(f.type(new FixedSizeBinary()).byteWidth());
		case Type["FixedSizeList"]: return new FixedSizeList$1(f.type(new FixedSizeList()).listSize(), (children || [])[0]);
		case Type["Map"]: {
...
/** @ignore */ var invalidMessageType = (type) => `Expected ${MessageHeader$1[type]} Message in stream, but was null or length 0.`;
/** @ignore */ var nullMessage = (type) => `Header pointer of flatbuffer-encoded ${MessageHeader$1[type]} Message is null or length 0.`;
...
var MessageReader = class {
	...
	readMessageBody(bodyLength) {
		if (bodyLength <= 0) return /* @__PURE__ */ new Uint8Array(0);
	...
	next() {
		...
		if (!this._schema) {
			...
			return {
				...
				value: Message.fromJSON(_json.schema, MessageHeader$1.Schema)
			};
		}
		if (this._dictionaryIndex < _json.dictionaries.length) {
			...
			return {
				...
				value: Message.fromJSON(batch, MessageHeader$1.DictionaryBatch)
			};
		}
		if (this._batchIndex < _json.batches.length) {
			...
			return {
				...
				value: Message.fromJSON(batch, MessageHeader$1.RecordBatch)
			};
		}
		this._body = [];
		return ITERATOR_DONE;
...
/** @ignore */
var MAGIC = /* @__PURE__ */ new Uint8Array(6);
...
var VectorAssembler = class VectorAssembler extends Visitor {
 ...
 /* istanbul ignore next */
			...
			if (!DataType.isNull(type)) addBuffer.call(this, nullCount <= 0 ? /* @__PURE__ */ new Uint8Array(0) : truncateBitmap(data.offset, length, data.nullBitmap));
...
function assembleUnion(data) {
	...
	if (type.mode === UnionMode$1.Sparse) return assembleNestedVector.call(this, data);
...
function assembleBoolVector(data) {
	let values;
	if (data.nullCount >= data.length) return addBuffer.call(this, /* @__PURE__ */ new Uint8Array(0));
...
function assembleListVector(data) {
	...
	if (valueOffsets) addBuffer.call(this, rebaseValueOffsets(valueOffsets[0], length, valueOffsets));
...
var RecordBatchWriter = class extends ReadableInterop {
	...
	write(payload) {
		...
		else if (payload instanceof RecordBatch$2 && !(schema = payload.schema)) return this.finish() && void 0;
		if (schema && !compareSchemas(schema, this._schema)) {
	...
	_writeMessage(message, alignment = 8) {
		...
		if (message.headerType === MessageHeader$1.RecordBatch) this._recordBatchBlocks.push(new FileBlock(alignedSize, message.bodyLength, this._position));
		else if (message.headerType === MessageHeader$1.DictionaryBatch) this._dictionaryBlocks.push(new FileBlock(alignedSize, message.bodyLength, this._position));
...
Builder$3["throughDOM"] = builderThroughDOMStream;
...
//#endregion
//#region node_modules/streamlit-component-lib/dist/ArrowTable.js
/**
...
var ArrowTable = function() {
	function ArrowTable(dataBuffer, indexBuffer, columnsBuffer, styler) {
		...
		this.getContent = function(table, rowIndex, columnIndex) {
			...
			switch (_this.getColumnTypeId(table, columnIndex)) {
				case Type$1.Timestamp: return _this.nanosToDate(column.get(rowIndex));
				default: return column.get(rowIndex);
			}
		};
	...
	*/
	...
	ArrowTable.prototype.nanosToDate = function(nanos) {
		return /* @__PURE__ */ new Date(nanos / 1e6);
	};
	return ArrowTable;
}();
//#endregion
//#region node_modules/streamlit-component-lib/dist/streamlit.js
/**
* Copyright (c) Streamlit Inc. (2018-2022) Snowflake Inc. (2022)
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
var Streamlit = function() {
	...
	*/
	Streamlit.setComponentReady = function() {
		...
		Streamlit.sendBackMsg(ComponentMessageType.COMPONENT_READY, { apiVersion: Streamlit.API_VERSION });
	};
	/**
	...
	*/
	Streamlit.setFrameHeight = function(height) {
		if (height === void 0) height = document.body.scrollHeight;
	...
	*/
	...
	Streamlit.onMessageEvent = function(event) {
		switch (event.data["type"]) {
			case Streamlit.RENDER_EVENT: Streamlit.onRenderMessage(event.data);
		}
	};
	/**
	...
	*/
	Streamlit.onRenderMessage = function(data) {
		...
		var event = new CustomEvent(Streamlit.RENDER_EVENT, { detail: eventData });
...
//#endregion
//#region node_modules/streamlit-component-lib/dist/StreamlitReact.js
/**
* Copyright (c) Streamlit Inc. (2018-2022) Snowflake Inc. (2022)
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
function withStreamlitConnection(WrappedComponent) {
	var ComponentWrapper = function(_super) {
		...
		function ComponentWrapper(props) {
			...
			_this.componentDidUpdate = function() {
				if (_this.state.componentError != null) Streamlit.setFrameHeight();
			};
		...
		ComponentWrapper.prototype.render = function() {
			if (this.state.componentError != null) return import_react.createElement("div", null, import_react.createElement("h1", null, "Component Error"), import_react.createElement("span", null, this.state.componentError.message));
			if (this.state.renderData == null) return null;
			return import_react.createElement(WrappedComponent, {
	...
	return (0, import_hoist_non_react_statics_cjs.default)(ComponentWrapper, WrappedComponent);
}
//#endregion
export { ArrowTable, Streamlit, StreamlitComponentBase, withStreamlitConnection };
